...
describe('/projects/{projectID}/canvas/{canvasID}', function() {
  ...
  describe('get', function() {
    ...
    //   /*eslint-enable*/
    //   request({
    //     url: 'http://localhost:3001/api/v1/projects/' + project1._id + 'bad request' + '/canvas/' + project1.persistent.canvases[0]._id,
    //     json: true,
    //     method: 'GET',
    //     headers: {
    //       'Content-Type': 'application/json',
