...
describe('/projects/{projectID}/canvas/', function() {
  ...
  describe('post', function() {
    it('should respond with 200 Success', function(done) {
      ...
      /*eslint-enable*/
      request({
        url: 'http://localhost:3001/api/v1/projects/' + project1._id + '/canvas/',
        json: true,
        method: 'POST',
        headers: {
    ...
    it('should respond with 400 Bad Request', function(done) {
      ...
      request({
        ...
        body: {
          "title": "string",
          "type": "string" // should be bad request
        }
      },
      function(error, res, body) {
        if (error) return done(error);
    ...
    it('should respond with 403 Forbidden', function(done) {
      ...
      /*eslint-enable*/
      request({
        url: 'http://localhost:3001/api/v1/projects/' + project2._id + '/canvas/',
        json: true,
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
